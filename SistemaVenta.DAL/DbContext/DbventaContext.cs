...
public partial class DbventaContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C8AFCE01F");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F1F5B9045");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483328544C3");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4DF66F4C7");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A39EC909B");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132F7DA9FA7");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76DB25FBC4");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6B501623D");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56147CCCD740");
